...
class HomeViewModel: ObservableObject {
    ...
    init() {
        ...
        if !initialInstall {
            let initialTrainingMenu = TrainingMenu(name: String(localized: "トレーニング"), trainingTime: 20, restTime: 2, repetitions: 2, sets: 2, restBetweenSets: 3, prepareTime: 3, createdAt: Date(), index: 0, isSelected: true)
